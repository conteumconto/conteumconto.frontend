...
<template>
  <div>
    ...
    <div class="nav-options" v-show='options'>
      <ul>
          <li><a href="#/" @click="options = !options" >Página Inicial</a></li>
          <!--<li><a href="#" @click="options = !options" >Portal</a></li>-->
          <li><a href="#/meusLivros" @click="options = !options" >Estante de Livros</a></li>
          <!--<li><a href="#" @click="options = !options" >Estatísticas</a></li>-->
          <li><a href="#/editarPerfil" @click="options = !options" >Perfil</a></li>
      </ul>
    </div>
