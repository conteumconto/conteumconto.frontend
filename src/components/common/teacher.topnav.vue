...
<template>
  <div>
    ...
    <div class="teacher-topnav">
      ...
      <div class="controls">
        <a @click="logout" class="item" href="#/entrar" >
    ...
    <div class="nav-options" v-show='options'>
      <ul>
          <li><a href="#/painel" @click="options = !options" >Página Inicial</a></li>
          <!--<li><a href="#" @click="options = !options" >Portal</a></li>-->
          <li><a href="#/turmas" @click="options = !options" >Turmas</a></li>
          <!--<li><a href="#" @click="options = !options" >Estatísticas</a></li>-->
          <li><a href="#/perfilProfessor" @click="options = !options" >Perfil</a></li>
      </ul>
    </div>
